...
namespace Gestor_Pedidos
{
    public partial class VPedidos : System.Web.UI.Page
    {
        ...
        protected void VisualizarPedidos()
        {
            ...
            {
                SqlCommand cmd1 = new SqlCommand("SELECT p.id_pedido, p.estado, f.fecha FROM dbo.pedido p JOIN dbo.factura f ON p.id_pedido = f.id_pedido WHERE f.id_usuario = @id_usuario;", sqlConectar);

...
namespace Gestor_Pedidos
{
    public partial class Pedido : System.Web.UI.Page
    {
        ...
        protected void BtnAgregarProducto_Click(object sender, EventArgs e)
        {
            ...
            this.cantidad = int.Parse(txtBoxCantidad.Text);
            ...
            if (stockDisponible < this.cantidad || 0 == this.cantidad)
            {
        ...
        {
            string zona = ltsBoxZona.Text;
            string formaPago = rbListFormaPago.Text;
            string conectar = ConfigurationManager.ConnectionStrings["conexion"].ConnectionString;
            int idPago = 0;
            SqlConnection sqlConectar = new SqlConnection(conectar);
            ...
            // Insertar factura
            SqlCommand cmd5 = new SqlCommand("INSERT INTO dbo.factura (id_pedido, id_cliente, id_pago, totalCompra, fecha) VALUES (@id_pedido, @id_cliente, @id_pago, @totalCompra, @fecha);", sqlConectar);
            cmd5.Parameters.AddWithValue("@id_pedido", idPedido);
            cmd5.Parameters.AddWithValue("@id_cliente", usuarioLogueado.Id);
